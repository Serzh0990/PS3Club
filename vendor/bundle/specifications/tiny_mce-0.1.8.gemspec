...
Gem::Specification.new do |s|
  ...
  s.authors = ["Blake Watters", "Kieran Pilkington", "Sergio Cambra", "Alexander Semyonov", "Marian Theisen", "Walter McGinnis", "Frederico Macedo de Assun\u{c3}\u{a7}\u{c3}\u{a3}o", "Josh Proehl", "Sasha Gerrand"]
  s.date = "2011-09-27"
