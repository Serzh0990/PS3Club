...
class WishesControllerTest < ActionController::TestCase
  ...
  test "should create wish" do
    assert_difference('Wish.count') do
      post :create, wish: { complete: @wish.complete, description: @wish.description, title: @wish.title }
    end
  ...
  test "should update wish" do
    patch :update, id: @wish, wish: { complete: @wish.complete, description: @wish.description, title: @wish.title }
    assert_redirected_to wish_path(assigns(:wish))
  end
